...
| `update_note`       | `id: string`, `title?: string`, `appendBody?: string`, `appendChecklistItems?: string[]`, `toggleChecklistItems?: string[]`, `pinned?: boolean`, `archived?: boolean` | Update an existing note, append text, add checklist tasks, toggle checklist items between done/undone, or archive/pin. |
