...
export type RotationPorts = {
	...
	/** Register a new key and account, and put this workspace on it. */
	createReplacement(): Promise<void>;
	/** Push the workspace to the new account. */
	uploadAll(): Promise<void>;
	countLocalRecords(): Promise<number>;
	countRemoteRecords(): Promise<number>;
	/** Put the previous key back and delete the new account. Only ever called
