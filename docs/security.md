...
- Sync history keeps prior encrypted envelopes on the relay for up to 30 days;
  only a device with the sync key can read their note content. History responses
